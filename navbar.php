...
<div class='sidebar' id="sidebar" class='mx-lt-5 bg-info' >
		...
		<!--  Change Button Color (style="background-color:#00b2ff;)-->
			...
			<?php endif; ?>
			<?php if($_SESSION['login_type'] == 1): ?>
			<center> <img src="assets/img/Boomboomwashlogo.png" alt="" style=" margin-top:-1050px; margin-left:0px;width:300px;height:250px;"> </center>
			<center> <img src="assets/img/LaundryTechLogo.png" alt="" style=" margin-top:-20px; margin-left:0px;width:150px;height:150px;"> </center>
			...
			<center> <img src="assets/img/Boomboomwashlogo.png" alt="" style=" margin-top:-860px; margin-left:0px;width:300px;height:250px;"> </center>
			<center> <img src="assets/img/LaundryTechLogo.png" alt="" style=" margin-top:-20px; margin-left:0px;width:150px;height:150px;"> </center>
			<center><b id="runningDate" class="text-center mb-0 pa-0"></b></center>
			<center><b id="runningTime" class="text-center mb-0 pa-0"></b></center>
			<?php endif; ?>
